...
//  Sw/Hw release
//#define REV_A              // configuration for Arduino Uno on Breadboard
...
// Tests levels               (each level enables debugging messages on usb port)
...
//#define _TEST_SIM800
//#define _TEST_LEDS        // to test leds forcing led status via USB - NEEDS _TEST_ON_USB 
...
//#define _TEST_SMS_COMMAND  // test command execution received via sms  // NEEDS _TEST_ON_USB if you want to send commands via usb 
